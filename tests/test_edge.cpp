...
bool test_2x2_large_block() { std::vector<double> A, B; fill_pattern(A, 2); fill_pattern(B, 2); return test_matrix(2, 2, A, B); }
...
REGISTER_TEST("2x2 block=2", test_2x2_large_block);
